          ...
          >
            ...
            >
              ...
              <p>
                ...
                giới, mà chúng tôi còn cung cấp thông tin hữu ích và các bài
                viết chuyên sâu cho người nuôi cá.
              </p>
            </div>
          ...
          <section className="best-sellers">
            ...
            <div className="product-list d-flex flex-wrap justify-content-center">
              ...
              >
                ...
                <div
                  style={{ borderBottom: "2px solid black", margin: "10px 0" }}
                ></div>
                ...
                <div className="mb-2 d-flex flex-row gap-2 justify-content-center">
                  <button className="rounded" style={{ background: "#C70025" }}>
                    Mua ngay
                  </button>
                  <button
              ...
              <div className="card mb-3 p-2 me-3">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    Thức ăn không chỉ ảnh hưởng đến chất lượng cá koi, mà còn...
                  </p>
                  <p className="card-text">
